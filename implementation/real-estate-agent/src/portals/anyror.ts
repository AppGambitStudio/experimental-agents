...
// 3. If portal returns error, return portal_unavailable flag for fallback to Playwright MCP (mcp__playwright__browser_navigate, browser_snapshot, browser_fill_form)
      ...
      return successResult(
        {
          ...
          portal_unavailable: true,
          message:
            "AnyRoR portal is unavailable. Use Playwright MCP (mcp__playwright__browser_navigate, browser_snapshot, browser_fill_form) to access land records manually.",
